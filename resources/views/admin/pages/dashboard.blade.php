            ...
            <ul class="list-group list-group-lg m-b-none">
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="{{ asset('/public/admin/img/a1.jpg') }}" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="{{ asset('/public/admin/img/a2.jpg') }}" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="{{ asset('/public/admin/img/a3.jpg') }}" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="{{ asset('/public/admin/img/a4.jpg') }}" class="r r-2x">
                </a>
                <span class="pull-right label bg-warning inline m-t-sm">Editor</span>
          ...
          <div class="list-group list-group-lg list-group-sp">
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="{{ asset('/public/admin/img/a4.jpg') }}" alt="...">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="{{ asset('/public/admin/img/a5.jpg') }}" alt="...">
                <i class="on b-white right"></i>
              </span>
              <span class="clear">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="{{ asset('/public/admin/img/a6.jpg') }}" alt="...">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="{{ asset('/public/admin/img/a7.jpg') }}" alt="...">
                <i class="busy b-white right"></i>
              </span>
              <span class="clear">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="{{ asset('/public/admin/img/a8.jpg') }}" alt="...">
