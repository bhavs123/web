                    ...
                    <div class="summary entry-summary">
                        ...
                        <form name="fromcart" id="prodId-[[ prods.id ]]" method="post" class="cart" action="javascript:void(0);">
                            <div class="form-row form-row-wide address-field validate-required">		
                                ...
                                $attrVal = App\Models\AttributeValue::where('attr_id','=', $attributeID)->get();
                                ?>
                                <div class="selection-box">
                                    <select name="attributeval[]" class="country_to_state country_select">
                                        <option value="">-- Please Select --</option>
                                        <?php foreach ($attrVal as $attributeValue) {
                                            ?>
                                            <option value="<?php echo $attributeValue->id ?>"><?php echo $attributeValue->option_name ?></option>
