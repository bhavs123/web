                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            <li class="payment_method_paypal">
                                                <input id="payment_method_cod" type="radio" class="input-radio" name="payment_method" value="COD"  data-order_button_text="COD" />
                                                <label for="payment_method_cod"><span></span>COD </label>
                                        ...
                                        <div style="float:right;">
                                            ...
                                            <a href="{{route('shipping')}}" class="dt-sc-button smallwidth"> Back </a></div>
                                        <div class="clear"></div>
